...
MoveableWidget::MoveableWidget(QWidget * parent)
	: QWidget(parent)
...
void MoveableWidget::setMoveWidget(QWidget* wid)
{
...
void MoveableWidget::setSpringBackWidget(QWidget*widget)
{
	m_springbackWidget = widget;
}

bool MoveableWidget::eventFilter(QObject *obj, QEvent *evt)
{
...
void MoveableWidget::springBack(QObject *, QEvent *)
{
...
void MoveableWidget::horizonSpringBack(QObject *, QEvent *)
{
	QRect  curScreenRect = QApplication::desktop()->screenGeometry(QCursor::pos());

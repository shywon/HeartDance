...
class QPushButton;
class QLabel;
class ScreenShareTimeWidget;
class ShareScreenToolWidget : public MoveableWidget
{
	Q_OBJECT
public:
    explicit ShareScreenToolWidget(QWidget *parent = nullptr);
...
private:
	...
	QLabel * m_line;//间隔线
    ScreenShareTimeWidget*m_shareTimeWidget;//共享时间
